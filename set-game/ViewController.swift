    ...
    func loadUI() {
        ...
        for i in 0..<cardButtons.count {
            if game.getCard(index: i) != nil {
                ...
                for _ in 0..<game.getCard(index: i)!.count.rawValue {
                    temp.append(game.getCard(index: i)!.symbol.rawValue)
                }
                ...
                if game.getCard(index: i)!.color == Color.green {
                    color = #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
                } else if game.getCard(index: i)!.color == Color.purple {
